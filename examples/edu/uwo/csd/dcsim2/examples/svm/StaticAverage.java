...
public class StaticAverage {
	...
	public static void main(String args[]) {
		...
		runSimulation("staticavg-1", 1088501048448116498l);
//		runSimulation("staticavg-2", 3081198553457496232l);
//		runSimulation("staticavg-3", -2485691440833440205l);
//		runSimulation("staticavg-4", 2074739686644571611l);
//		runSimulation("staticavg-5", -1519296228623429147l);
