...
public class VMRelocationPolicyFFIM extends VMRelocationPolicyGreedy {
	 ...
	 */
	public VMRelocationPolicyFFIM(DataCentre dc, DCUtilizationMonitor utilizationMonitor, double lowerThreshold, double upperThreshold, double targetUtilization) {
