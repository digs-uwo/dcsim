...
public class VMRelocationPolicyFFDM extends VMRelocationPolicyGreedy {
	 ...
	 */
	public VMRelocationPolicyFFDM(DataCentre dc, DCUtilizationMonitor utilizationMonitor, double lowerThreshold, double upperThreshold, double targetUtilization) {
