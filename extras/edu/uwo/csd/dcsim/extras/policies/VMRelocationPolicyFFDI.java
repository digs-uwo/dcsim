...
public class VMRelocationPolicyFFDI extends VMRelocationPolicyGreedy {
	 ...
	 */
	public VMRelocationPolicyFFDI(DataCentre dc, DCUtilizationMonitor utilizationMonitor, double lowerThreshold, double upperThreshold, double targetUtilization) {
